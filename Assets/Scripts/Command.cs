...
public class Command
{
    ...
    private readonly int lenCaption;
    ...
    public void paint(mGraphics g)
    {
        if (img != null)
        {
            ...
            if (caption is not "menu" and not null)
            {
                if (!isFocus)
                {
                ...
                {
                    mFont.tahoma_7b_yellow.drawString(g, caption, x + (mGraphics.getImageWidth(img) / 2), y + (mGraphics.getImageHeight(img) / 2) - 5, 2);
                }
            }
            return;
        }
        ...
        {
            mFont.tahoma_7b_yellow.drawString(g, caption, num, y + 7, 2);
        }
    }
