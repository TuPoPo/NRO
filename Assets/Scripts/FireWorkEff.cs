public class FireWorkEff
{
    ...
    private static readonly MyRandom r = new();

    private static readonly MyVector mg = new();
    ...
    private static readonly int[] mang_x = new int[3];

    private static readonly int[] mang_y = new int[3];

    private static bool st = false;

    private static long last = 0L;

    private static readonly long delay = 150L;
    ...
    public static void animate()
    {
        ...
        mang_y[0] = y;
        mang_x[0] = x;
        x = (Res.cos((int)(ag * System.Math.PI / 180.0)) * v * t) + x0;
        y = (int)((v * Res.sin((int)(ag * System.Math.PI / 180.0)) * t) - (a * t * t / 2f)) + y0;
        if (time() - last >= delay)
        {
            t++;
            last = time();
