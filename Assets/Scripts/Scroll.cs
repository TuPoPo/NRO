...
public class Scroll
{
    ...
    {
        return styleUPDOWN ? updateKeyScrollUpDown(false) : updateKeyScrollLeftRight();
    }

    public ScrollResult updateKey(bool isGetSelectNow)
    {
        return styleUPDOWN ? updateKeyScrollUpDown(isGetSelectNow) : updateKeyScrollLeftRight();
    }
