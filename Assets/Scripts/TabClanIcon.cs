...
public class TabClanIcon : IActionListener
{
    ...
    private readonly Command left;

    private readonly Command right;
    ...
    private readonly int disStart = 50;
    ...
    private readonly ScrollResult sr;
    ...
    public void init()
    {
        ...
        cmx = x;
        cmtoX = 0;
        nItem = !isRequest ? ClanImage.vClanImage.size() : vItems.size();
    ...
    public void perform(int idAction, object p)
    {
        ...
        {
            _ = (Item)vItems.elementAt(select);
        }
    }
}
