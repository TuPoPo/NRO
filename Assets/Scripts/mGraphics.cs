...
public class mGraphics
{
    ...
    public static Hashtable cachedTextures = new();
    ...
    public void fillRect(int x, int y, int w, int h, int boderRadiusTopLeft, int boderRadiusTopRight, int boderRadiusBottomLeft, int boderRadiusBottomRight)
    {
        boderRadiusTopLeft *= zoomLevel;
        boderRadiusTopRight *= zoomLevel;
        boderRadiusBottomLeft *= zoomLevel;
        boderRadiusBottomRight *= zoomLevel;
        ...
        GUI.DrawTexture(new Rect(num - num4, num2 - num5, w, h), texture2D,
            ScaleMode.StretchToFill, false, 0, Color.white, new Vector4(boderSize, boderSize, boderSize, boderSize),
            new Vector4(boderRadiusTopLeft, boderRadiusTopRight, boderRadiusBottomRight, boderRadiusBottomLeft));
    ...
    public void __drawRegion(Image image, int x0, int y0, int w, int h, int transform, float x, float y, int anchor)
    {
        ...
        int num16 = 0;
        int num17 = 0;
        if (transform is 5 or 6 or 4 or 7)
        {
        ...
        Graphics.DrawTexture(new Rect(x + num3 + num14 + num16, y + num4 + num17 + num15, num * num7, num2 * num9), image.texture, new Rect((x0 + num3 + num8) / image.texture.width, (image.texture.height - num2 - (y0 + num4)) / image.texture.height, num / image.texture.width, num2 / image.texture.height), 0, 0, 0, 0);
        if (transform is 5 or 6 or 4 or 7)
        {
    ...
    {
        return color != Color.clear && color != transParentColor;
    }
    ...
    public static Image blend(Image img0, float level, int rgb)
    {
        ...
        float num5 = num2 / 256f;
        float num6 = num3 / 256f;
        Color color = new(num6, num5, num4);
