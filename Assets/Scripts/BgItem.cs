...
public class BgItem
{
    ...
    public static MyHashTable imgNew = new();

    public static MyVector vKeysNew = new();

    public static MyVector vKeysLast = new();
    ...
    public void paint(mGraphics g)
    {
        ...
        int cmx = GameScr.cmx;
        int cmy = GameScr.cmy;
        Image image = layer is 2 or 4 ? (Image)imgNew.get(idImage + string.Empty) : isNotBlend() ? (Image)imgNew.get(idImage + string.Empty) : (Image)imgNew.get(idImage + "blend" + layer);
