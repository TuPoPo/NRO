...
namespace Assets.src.g
{
    internal class Mabu : Char
    {
        ...
        public void eat(int id)
        {
            ...
            focus = id == Char.myCharz().charID ? Char.myCharz() : GameScr.findCharInMap(id);
        }
        ...
        public new void checkFrameTick(int[] array)
        {
            if (skillID == 0)
            {
                ...
                {
                    addFoot = true;
                    Effect effect = new(19, cx, cy + 20, 2, 1, -1);
        ...
        public override void update()
        {
            ...
            if (skillID != -1)
            {
                ...
                {
                    dx += (xTo <= cx) ? (-30) : 30;
                    Effect effect = new(103, cx + dx, cy + 20, 2, 1, -1)
                    {
                        trans = (xTo <= cx) ? 1 : 0
                    };
                    EffecMn.addEff(effect);
                ...
                {
                    Effect effect2 = new(19, cx, cy, 2, 1, -1);
