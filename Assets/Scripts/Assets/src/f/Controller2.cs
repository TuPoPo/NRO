                    ...
                    case 51:
                        {
                            ...
                            for (int num21 = 0; num21 < b20; num21++)
                            {
                                ...
                                array2[num21] = null;
                                array2[num21] = num22 != Char.myCharz().charID ? GameScr.findCharInMap(num22) : Char.myCharz();
                    ...
                    case 102:
                        {
                            ...
                            if (b24 is 0 or 1 or 2 or 6)
                            {
                                ...
                                for (int num34 = 0; num34 < b25; num34++)
                                {
                                    ...
                                    array7[num34] = null;
                                    array7[num34] = num35 != Char.myCharz().charID ? GameScr.findCharInMap(num35) : Char.myCharz();
                                    array8[num34] = msg.reader().readInt();
                                }
                                bigBoss2.setAttack(array7, array8, b24);
                            }
                            if (b24 is 3 or 4 or 5 or 7)
                            {
                                ...
                                if (b24 is 3 or 4)
                                {
                                    ...
                                    for (int num36 = 0; num36 < b26; num36++)
                                    {
                                        ...
                                        array9[num36] = null;
                                        array9[num36] = num37 != Char.myCharz().charID ? GameScr.findCharInMap(num37) : Char.myCharz();
                    ...
                    case 101:
                        {
                            ...
                            if (b21 is 0 or 1 or 2 or 4 or 3)
                            {
                                if (b21 == 3)
                                {
                                ...
                                else
                                {
                                    ...
                                    for (int num23 = 0; num23 < b22; num23++)
                                    {
                                        ...
                                        array4[num23] = null;
                                        array4[num23] = num24 != Char.myCharz().charID ? GameScr.findCharInMap(num24) : Char.myCharz();
                    ...
                    case -100:
                        {
                            ...
                            for (int i = 0; i < num; i++)
                            {
                                ...
                                {
                                    template = ItemTemplates.get(num2),
                                    itemId = msg.reader().readShort(),
                                    buyCoin = msg.reader().readInt(),
                                    buyGold = msg.reader().readInt(),
                                    buyType = msg.reader().readByte(),
                                    quantity = msg.reader().readInt(),
                                    isMe = msg.reader().readByte()
                                };
            ...
            try
            {
                ...
                if (actionBoss is >= 11 and <= 20)
                {
                    ...
                    for (int i = 0; i < b; i++)
                    {
                        int num = msg.reader().readInt();
                        array[i] = null;
                        array[i] = num != Char.myCharz().charID ? GameScr.findCharInMap(num) : Char.myCharz();
