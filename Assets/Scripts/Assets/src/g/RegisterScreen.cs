...
namespace Assets.src.g
{
    public class RegisterScreen : mScreen, IActionListener
    {
        ...
        private readonly Command cmdCheck;
        ...
        private readonly Command cmdBackFromRegister;
        ...
        private readonly string strUser;
        ...
        private readonly string passRe = string.Empty;
        ...
        {
            MyVector myVector = new("vMenu Login");
        ...
        public override void keyPress(int keyCode)
        {
            ...
            {
                _ = tfNgay.keyPressed(keyCode);
            }
            else if (tfThang.isFocus)
            {
                _ = tfThang.keyPressed(keyCode);
            }
            else if (tfNam.isFocus)
            {
                _ = tfNam.keyPressed(keyCode);
            }
            else if (tfDiachi.isFocus)
            {
                _ = tfDiachi.keyPressed(keyCode);
            }
            else if (tfCMND.isFocus)
            {
                _ = tfCMND.keyPressed(keyCode);
            }
            else if (tfNoiCap.isFocus)
            {
                _ = tfNoiCap.keyPressed(keyCode);
            }
            else if (tfSodt.isFocus)
            {
                _ = tfSodt.keyPressed(keyCode);
            }
            else if (tfNgayCap.isFocus)
            {
                _ = tfNgayCap.keyPressed(keyCode);
            }
