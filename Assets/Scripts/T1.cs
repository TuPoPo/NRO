...
public class T1 : mResources
{
    public static void load()
    {
        ...
        mResources.notify = "Thông Báo";
        mResources.quayso = "Mini game";
        mResources.gameInfo = "Chức Năng";
        mResources.notifyboss = "Thông báo BOSS";
        mResources.useGem = "Tự động hồi sinh";
        mResources.autoFunction = "Chức năng";
