...
public class Session_ME2 : ISession
{
    ...
    private class MessageCollector
    {
        ...
        private Message readMessage2(sbyte cmd)
        {
            ...
            sbyte[] array = ArrayCast.cast(src);
        ...
        private Message readMessage()
        {
            try
            {
                ...
                if (b is (-32) or (-66) or 11 or (-67) or (-74) or (-87))
                {
    ...
    protected static Session_ME2 instance = new();
    ...
    private static readonly Sender sender = new();
    ...
    private readonly long lastTimeConn;
    ...
    public static MyVector recieveMsg = new();
