...
public class Res
{
    private static readonly short[] sinz = new short[91]
    {
    ...
    public static MyVector debug = new();

    public static MyRandom r = new();
    ...
    public static void init()
    {
        ...
        {
            cosz[i] = sinz[90 - i];
            tanz[i] = cosz[i] == 0 ? int.MaxValue : (sinz[i] << 10) / cosz[i];
        }
    }
    ...
    {
        a = fixangle(a);
        return a is >= 0 and < 90 ? sinz[a] : a is >= 90 and < 180 ? sinz[180 - a] : a is >= 180 and < 270 ? -sinz[a - 180] : -sinz[360 - a];
    }

    public static int cos(int a)
    {
        a = fixangle(a);
        return a is >= 0 and < 90 ? cosz[a] : a is >= 90 and < 180 ? -cosz[180 - a] : a is >= 180 and < 270 ? -cosz[a - 180] : cosz[360 - a];
    }

    public static int tan(int a)
    {
        a = fixangle(a);
        return a is >= 0 and < 90 ? tanz[a] : a is >= 90 and < 180 ? -tanz[180 - a] : a is >= 180 and < 270 ? tanz[a - 180] : -tanz[360 - a];
    }
    ...
    public static string[] split(string original, string separator, int count)
    {
        ...
        if (num >= 0)
        {
            array = split(original[(num + separator.Length)..], separator, count + 1);
        }
        else
        {
