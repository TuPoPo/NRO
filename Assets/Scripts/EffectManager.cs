...
{
    public static EffectManager lowEffects = new();

    public static EffectManager mid_2Effects = new();

    public static EffectManager midEffects = new();

    public static EffectManager hiEffects = new();
