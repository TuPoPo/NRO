...
public class Npc : Char
{
    ...
    public override void update()
    {
        ...
        if (effTask == null)
        {
            ...
            else
            {
                ...
                {
                    effTask = Char.myCharz().taskMaint.index + 1 == Char.myCharz().taskMaint.subNames.Length ? GameScr.efs[98] : GameScr.efs[98];
                    indexEffTask = 0;
                }
            }
        }
    ...
    public override void paint(mGraphics g)
    {
        ...
        else
        {
            ...
            if (template.npcTemplateId is not 4 and not 51 and not 50)
            {
            ...
            {
                if (template.npcTemplateId is 50 or 51)
                {
                    if (duahau != null)
                    {
                        if (template.npcTemplateId == 50 && mabuEff)
                        {
                            ...
                            {
                                Effect effect = new(19, cx + Res.random(-50, 50), cy, 2, 1, -1);
                                EffecMn.addEff(effect);
                            }
                            if (GameCanvas.gameTick % 15 == 0)
                            {
                                Effect effect2 = new(18, cx + Res.random(-5, 5), cy + Res.random(-90, 0), 2, 1, -1);
        ...
        else
        {
            ...
            if (TileMap.mapID != 51)
            {
                ...
                if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
                {
                    ...
                    {
                        mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "]" + template.name, cx, cy - ch - mFont.tahoma_7.getHeight() - num2, mFont.CENTER, mFont.tahoma_7_grey);
                    }
                }
                else
                {
