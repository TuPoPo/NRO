...
public class Service
{
    ...
    public void buyItems(sbyte type, int id, int quantity)
    {
        Message message = null;
        try
        {
            message = new Message((sbyte)5);
    ...
    public void androidPack2()
    {
        ...
        try
        {
            message = new Message((sbyte)126);
            message.writer().writeUTF(mSystem.android_pack);
            session = Session_ME2.gI().isConnected() && !Session_ME2.connecting ? Session_ME2.gI() : Session_ME.gI();
            session.sendMessage(message);
    ...
    public void setClientType()
    {
        ...
        try
        {
            ...
            //   message.writer().writeUTF(Assets.Script.Functions.String_EnFunctions.getInstance().Hex2String(Assets.Script.Functions.String_EnFunctions.getInstance().ReverseString("23 66 46 83 36 63 16 03 66 36 46 83 23 26 33 53 33 26 83 03 36 73 13 73 53 93 36 56 26 43 53 93"), null));
            session.sendMessage(message);
            message.cleanup();
        }
        catch (Exception ex)
    ...
    public void upSkillPet(int typePotential, int num)
    {
        Message message = null;
        try
        {
    ...
    {
        Message message = new(sbyte.MaxValue);
        try
        {
    ...
    internal void getItem(sbyte bODY_BAG, int selected)
    {
