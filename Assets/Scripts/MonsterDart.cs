...
public class MonsterDart : Effect2
{
    ...
    private readonly DartInfo info;
    ...
    public override void update()
    {
        for (int i = 0; i < info.nUpdate; i++)
        {
            ...
            {
                angle = Math.abs(num2 - angle) < 15
                    ? num2
                    : num2 - angle is (>= 0 and < 180) or < (-180) ? Res.fixangle(angle + 15) : Res.fixangle(angle - 15);
            }
